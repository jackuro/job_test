...
<div class="container mt-4">
  ...
  <hr>
    <?php
     ...
     ?>
  <div class="mt-3">
     <table class="table table-bordered" id="branch-list">
       <thead>
          <tr>
             <th>Branch Id</th>
             <th>Name</th>
       ...
       <tbody>
          ...
          <tr>
             ...
             <td>
              <a href="<?php echo ('edit-view/'.$branch['id']);?>" class="btn btn-primary btn-sm">Edit</a>
              <a href="<?php echo ('delete/'.$branch['id']);?>" class="btn btn-danger btn-sm">Delete</a>
              </td>
          </tr>
         <?php endforeach; ?>
         <?php endif; ?>
